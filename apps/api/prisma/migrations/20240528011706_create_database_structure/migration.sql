...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_oragnization_id_fkey" FOREIGN KEY ("oragnization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
